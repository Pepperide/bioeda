...
type JobsClient interface {
	Submit(ctx context.Context, in *ScriptRequest, opts ...grpc.CallOption) (*SubmitResponse, error)
}
...
func (c *jobsClient) Submit(ctx context.Context, in *ScriptRequest, opts ...grpc.CallOption) (*SubmitResponse, error) {
...
type JobsServer interface {
	Submit(context.Context, *ScriptRequest) (*SubmitResponse, error)
...
func (UnimplementedJobsServer) Submit(context.Context, *ScriptRequest) (*SubmitResponse, error) {
...
func _Jobs_Submit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobsServer).Submit(ctx, req.(*ScriptRequest))
	}
...
var Jobs_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/submitter.proto",
}
